        ...
        NavHost(
            ...
            composable(SonaDestination.Library.route) {
                ...
                LibraryScreen(
                    ...
                    onDeleteFromActions = libraryViewModel::requestDeleteFromTrackActions,
                    onAddToPlaylist = libraryViewModel::addTrackActionSongToPlaylist,
                    onDismissTrackActions = libraryViewModel::dismissTrackActions,
                    onConfirmDelete = libraryViewModel::confirmDeleteTrack,
                    onDismissDelete = libraryViewModel::dismissDeleteConfirmation,
